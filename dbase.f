...
*	EXPERIMENT
	...
	ierr = regparmint('doing_deuterium_n',doing_deuterium_n_int,0)
...
*	SIMULATE
	...
	ierr = regparmdouble('drift_to_cal2',drift_to_cal2,0.0)
...
*       Rejection Sampling (RS)
	...
	ierr = regparmint('using_RS',using_RS_int,0)
	ierr = regparmdouble('max_weight_RS',max_weight_RS,0.0)
...
ccc
	...
	if(doing_deuterium_n_int.gt.0) doing_deuterium_n=.true.
	...
	if(using_Coulomb_int.gt.0) using_Coulomb=.true.
  	...
  	if(using_RS_int.gt.0) using_RS=.true. 
